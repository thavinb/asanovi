process UNICYCLER {
    ...
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/unicycler:0.4.8--py38h8e3bb3f_5' :
        'quay.io/biocontainers/unicycler:0.4.8--py38h8e3bb3f_5' }"
    ...
    def prefix = task.ext.prefix ?: "${meta.id}_unicycler"
